...
export default function SignUpForm({ className, ...props }: React.ComponentProps<"div">) {
  ...
  async function onSubmit(data: z.infer<typeof RegisterSchema>) {
    try {
      ...
      toast(t("global.registration_success"), {
        description: `${new Date().toLocaleString(locale)} - ${t("global.check_email")}`,
      });
      ...
      toast(t("global.registration_error"), {
        description: message,
      });
    }
  }
        ...
        <CardContent className="grid p-0 md:grid-cols-2">
          <Form {...form}>
            ...
            >
              ...
              >
                {form.formState.isSubmitting ? "..." : t("SignUp.form.submit")}
              </Button>
